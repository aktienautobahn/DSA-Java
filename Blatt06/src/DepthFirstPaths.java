...
public class DepthFirstPaths {
        ...
        while (!stack.isEmpty()) {
            ...
            if (adj[v].hasNext()) {
                ...
                if (!marked[w]) {
                    ...
                    marked[w] = true;
                    preorder.add(w); // added
                    edgeTo[w] = v; // added
                    distTo[w] = distTo[edgeTo[w]] + 1; // added
    ...
    public List<Integer> pathTo(int v) {
        ...
        // return the list from preorder list till the v
        List<Integer> pathToS = new LinkedList<Integer>();
