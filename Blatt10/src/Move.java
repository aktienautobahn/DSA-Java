/**
 * Move formalizes the move of a robot, specified by the index of the robot and the direction.
...
public class Move {
    ...
    // moves to the targetPosition's direction, till the first obstacle
